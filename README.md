...
<div style='font-size:13px;opacity:0.92;'>Lineage heat: 1 outbound / 0 inbound · ✅ No engine drift detected · Index coverage: ready · PII: 2 · Changelog: fresh (2 d)</div>
</div>
...
- Pkg folder: [packages\sync-batch-items](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\sync-batch-items)
...
graph LR
  ...
  sync_batch_items["sync_batch_items"]:::center
  sync_batch_items -->|FK| sync_batches["sync_batches"]:::link
...
- Outbound (depends on): "sync_batches"
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package sync-batch-items -Apply
