...
> Schema package for table **sync_batch_items** (repo: `sync-batch-items`).
...
| id | BIGINT | — | AS | PK |
| batch_id | BIGINT | NO | — |  |
| event_key | CHAR(36) | NO | — |  |
| status | TEXT | NO | 'pending' |  |
| error | TEXT | YES | — |  |
| created_at | TIMESTAMPTZ(6) | NO | CURRENT_TIMESTAMP(6) |  |

## Relationships
- FK → **sync_batches** via (batch_id) (ON DELETE CASCADE).
...
erDiagram
  ...
  SYNC_BATCH_ITEMS }o--|| SYNC_BATCHES : "batch_id"
```
