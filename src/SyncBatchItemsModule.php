...
final class SyncBatchItemsModule implements ModuleInterface
{
    public function name(): string { return 'table-sync_batch_items'; }
    public function table(): string { return 'sync_batch_items'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-sync_batches' ]; }

    public static function contractView(): string { return 'vw_sync_batch_items'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_sbi_batch', 'idx_sbi_status' ];
        if ($d->isMysql()) {
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_sbi_batch', 'idx_sbi_status' ],
            'foreignKeys' => [ 'fk_sbi_batch' ],
        ];
    }
}
