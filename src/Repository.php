...
namespace BlackCat\Database\Packages\SyncBatchItems;
...
use BlackCat\Database\Packages\SyncBatchItems\Repository\SyncBatchItemRepository as GeneratedRepository;
...
{
  private SyncBatchItemRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof SyncBatchItemRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected SyncBatchItemRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SyncBatchItems\Dto\SyncBatchItemDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SyncBatchItems\Dto\SyncBatchItemDto|null { return $this->repo->getById($id, $asDto); }
