...
use BlackCat\Database\Packages\SyncBatchItems\Repository\SyncBatchItemRepository;
...
{
    private SyncBatchItemRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new SyncBatchItemRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\SyncBatchItems\Dto\SyncBatchItemDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\SyncBatchItems\Dto\SyncBatchItemDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\SyncBatchItems\Dto\SyncBatchItemDto|null
    {
