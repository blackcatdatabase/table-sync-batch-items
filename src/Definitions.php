...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'sync_batch_items'; }
    public static function contractView(): string { return 'vw_sync_batch_items'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'batch_id', 'event_key', 'status', 'error', 'created_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'batch_id', 'event_key' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'batch_id' ]; }
